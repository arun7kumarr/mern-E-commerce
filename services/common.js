...
let transporter = nodemailer.createTransport({
  ...
  secure: false,
  auth: {
    user: 'arunkumar07032002@gmail.com', 
...
exports.cookieExtractor = function (req) {
  ...
  // token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY2NjViMGJkYTFlOTM5MWVhNTIwMzA1NiIsInJvbGUiOiJhZG1pbiIsImlhdCI6MTcxODc4MDAxMX0.ni3vnyxQmgUC24ykmkArleMQ6048HCetLiaHIl40WpA"
  return token;
};
...
exports.sendMail = async function ({to, subject, text, html}){
  let info = await transporter.sendMail({
      from: '"E-commerce" <arunkumar07032002@gmail.com>', 
      to,
      subject,
      text,
      html
         ...
         <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
           ...
           <tr>
             <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
               <p style="margin: 0;">Here is a summary of your recent order. If you have any questions or concerns about your order, please <a href="arunkumar07032002@gmail.com">contact us</a>.</p>
             </td>
           </tr>
           <!-- end copy -->
           <!-- start receipt table -->
